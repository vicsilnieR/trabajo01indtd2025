...
format: 
  typst-pdf: 
    ...
    include-before-body: toc-sep.typ
    code-fold: false
    theme: cosmo
  html:
    toc: true
...
Vamos ahora a mostrar los resultados de aplicar todos los criterios de decisión bajo incertidumbre para el caso desfavorable, en la sieuiente tabla.

```{r}
resultado2_desfavorable <- criterio.Todos(tabla_decision2, alfa = 0.5, favorable = FALSE)
res_desfavorable <- as.data.frame(resultado2_desfavorable)
crea_tabla_estilo(res_desfavorable, nombresfila = TRUE)
```
